...
func (r *MongoRepo) GetTeamByExternalID(ctx context.Context, externalID string) (Team, error) {
	var team Team
...
func (r *MongoRepo) UpdateTeamExternalID(ctx context.Context, id primitive.ObjectID, externalID string) error { // TODO: remove this update use the generic update
	filter := primitive.M{"_id": id}
...
func (r *MongoRepo) GetPlayerByExternalID(ctx context.Context, externalID string) (Player, error) { // TODO: remove this update use the generic get
	var player Player
	filter := primitive.M{"external_id": externalID}
...
func (r *MongoRepo) UpdateGameByExternalID(ctx context.Context, externalID string, updateData bson.M) error { //TODO: remove this update use the generic update
